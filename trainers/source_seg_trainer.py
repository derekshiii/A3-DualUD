...
class SourceDomainTrainer():
    ...
    def train(self):
        ...
        best_model_path = '/media/dell/disk2/zhoujie/MICCAI23-deeplab_TCT/source_seg/DeepLab_Abdomen_MR_Seg/exp_8_time_2024-06-17 15-58-09/saved_models/model_epoch_100_dice_0.9211.pth'
        ...
        with torch.no_grad():
            ...
            for it, (val_imgs, val_segs, val_names) in enumerate(val_iterator):
                ...
                predict, _ = self.validate_one_step([val_imgs, val_segs])
